...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'serial_no',                    'default': '840412060192', 'description': 'choose device by serial number'},
...
launch_only_parameters = [
    {'name': 'use_lifecycle_node', 'default': 'false', 'description': 'launch realsense2_camera as a LifecycleNode'},
]
...
def launch_setup(context, params, param_name_suffix=''):
    ...
    supported_params = set(param['name'] for param in configurable_parameters + launch_only_parameters)
    ...
    use_lifecycle_node = launch_config_as_bool(context, 'use_lifecycle_node' + param_name_suffix)
...
def generate_launch_description():
    return LaunchDescription(declare_configurable_parameters(configurable_parameters + launch_only_parameters) + [
